...
export default function Experience() {
  return (
    <div className="mx-auto max-w-4xl px-6 py-20 md:py-28">
      <SectionLabel index="04" label="Trayectoria" />

      <div className="relative mt-10 pl-8 md:pl-10">
        {/* línea de tiempo vertical */}
        <span className="absolute left-1.75 md:left-2.25 top-2 bottom-2 w-px bg-white/10" />
        ...
        >
          ...
          <div className="bg-carbon-light border border-white/10 rounded-2xl p-6 md:p-8 space-y-6">
            {/* cabecera: placa sponsor + empresa + rol */}
            <div className="flex flex-col sm:flex-row sm:items-center gap-5">
              <div className="shrink-0 bg-white rounded-xl px-4 py-3 flex items-center justify-center w-28 h-16">
                <img
                  src="/viewnext.png"
              ...
              <div className="flex-1">
                <div className="flex flex-wrap items-center gap-x-3 gap-y-1">
                  <h3 className="font-tech text-2xl font-black text-white">VIEWNEXT</h3>
                ...
                <p className="flex items-center gap-1.5 text-xs text-silver mt-1">
                  <MapPin className="w-3.5 h-3.5" /> Aldeatejada, Salamanca, España
                </p>
              </div>
            </div>
